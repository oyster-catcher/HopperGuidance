...
def sparsesolve(*functionargs):
    ...
    try:
        ...
        # call function
        _net_x, _net_rep = _net_alglib.sparsesolve(_net_a, _net_n, _net_b)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def sparselusolve(*functionargs):
    ...
    try:
        ...
        # call function
        _net_x, _net_rep = _net_alglib.sparselusolve(_net_a, _net_p, _net_q, _net_n, _net_b)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
